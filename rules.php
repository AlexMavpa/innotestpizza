...
<title><?php if ($login) { echo $login." - ";} ?>Rules - Innopizza - stay hungry, stay foolish!</title>
...
<p>Our site uses cookies. We collect some information about our users using this technology, and we also store the personal data of registered users (name, surname, phone number, orders) on our web server, using this data only for our own needs. None of your data will be freely available and is not disclosed to third parties.</p>
</div>
</div>
</div>
