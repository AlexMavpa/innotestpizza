...
<title><?php if ($login) { echo $login." - ";} ?>Special offers - Innopizza - stay hungry, stay foolish!</title>
...
<li class="nav-item active"><a class="nav-link" href="offers.php">Special offers</a></li>
...
<div class="col-lg-6">
<h2>Hot offers - cheap and tasty</h2>
<div class="row">
<div style="display:flex;flex-wrap: wrap;">
<?php 
$showInnoPizza = showInnoPizzaOffers();
echo $showInnoPizza;
			?>
</div>
</div>
